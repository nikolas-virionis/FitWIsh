...
function getBodyTypeAdvantage() {
  if (
    (bodytype == "ecto" && goal == "bulking") ||
    (bodytype == "ecto" && goal == "muscle") ||
    (bodytype == "endo" && goal == "cutting")
  )
    bodyTypeAdvantage = 0;
  else if (
    (bodytype == "ecto" && goal == "cutting") ||
    (bodytype == "meso" && goal == "surplus") ||
    (bodytype == "endo" && goal == "surplus")
  )
    bodyTypeAdvantage = 1;
  else if (
    (bodytype == "ecto" && goal == "surplus") ||
    (bodytype == "meso" && goal == "bulking") ||
    (bodytype == "meso" && goal == "cutting") ||
    (bodytype == "meso" && goal == "muscle") ||
    (bodytype == "endo" && goal == "bulking") ||
    (bodytype == "endo" && goal == "muscle")
  )
    bodyTypeAdvantage = 2;
}
function getDate() {
...
function getBodyTypeAdvantageAdviceMeso() {
  if (languageValue == 1) {
    if (bodyTypeAdvantage == 2)
      ...
      bodyTypeAdvantageAdvice = " That shouldn't happen! Sry.";
  } else if (languageValue == 2) {
    if (bodyTypeAdvantage == 2)
      bodyTypeAdvantageAdvice =
      ...
      bodyTypeAdvantageAdvice = " Isso não deveria acontecer! Desculpa.";
  } else if (languageValue == 3) {
    if (bodyTypeAdvantage == 2)
      bodyTypeAdvantageAdvice =
      ...
      bodyTypeAdvantageAdvice = " Cela ne devrait pas arriver! Pardon.";
  } else if (languageValue == 4) {
    if (bodyTypeAdvantage == 2)
      bodyTypeAdvantageAdvice =
      ...
      bodyTypeAdvantageAdvice = " ¡Eso no debería suceder! Lo siento.";
  }
}
...
function getBodyTypeAdvantageAdvice() {
  ...
  if (bodytype == "ecto") getBodyTypeAdvantageAdviceEcto();
  else if (bodytype == "meso") getBodyTypeAdvantageAdviceMeso();
  else if (bodytype == "endo") getBodyTypeAdvantageAdviceEndo();
}
function getBodyFat() {
  if (currentBody == 1) {
    if (gender == "male") {
...
function resultTime() {
  ...
  timeGaps += 1;
  if (timeGaps == 1500)
    finalResultH3Id.innerHTML += `${bodyTypeAdvantageAdvice}${goalDistance}<br><br>`;
  if (timeGaps == 2000) finalResultH3Id.innerHTML += `${ageAdvice}<br><br>`;
  if (timeGaps == 3000)
    finalResultH3Id.innerHTML += `${finalIdealWeightMsg}<br><br>`;
  if (timeGaps == 4000)
    finalResultH3Id.innerHTML += `${exerciseAdvice}<br><br>`;
  ...
  if (timeGaps == 11000)
    finalResultH3Id.innerHTML += `${calorieIntakeAdvice}<br><br><br>`;
  if (timeGaps == 12000) {
